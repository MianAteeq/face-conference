...
@include('layouts.head')
  @include('layouts.head', [
    'meta_title' => 'Register for FACEICON 2026 – Face by Surgeons Conference',
    'meta_description' => 'Secure your seat at FACEICON 2026. Early bird discounts available for general participants, PG trainees, students & members. Register before March 30, 2026.'
])
...
<body>
                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"><img
                                ...
                                class="img img-responsive" style="width: 120px;"></a>
                    </div>
         ...
         <section class="hero parallax events-hero" data-bg-image="/assets/images/events/hero-bg.jpg">
            <div class="hero-title">
                ...
                <ul class="social-links">
                   <li><a href="https://www.facebook.com/PALDPAKISTAN"><i
                                class="fa fa-facebook"></i></a></li>
                    
                    <li><a
                            href="https://www.instagram.com/pakacademyoflaser/"><i
                                class="fa fa-instagram"></i></a></li>
                    <li><a href="https://api.whatsapp.com/send?phone=923363365111"><i class="fa fa-whatsapp"></i></a>
                    </li>
            ...
            <div class="containers">
                ...
                <form id="registrationForm" method="POST" action="{{ route('register') }}"
                    ...
                    <div class="step-content" id="step2">
                        ...
                        <div class="form-group">
                            <label>Accompanying Person (Rs. 6,000 each)</label>
                    ...
                    <div class="step-content" id="step3">
                        ...
                        <div id="bankDetails" class="hidden">
                            <p><strong>Bank Details</strong><br>
                                Title: PAK ACADEMY OF LASER DENTISTRY<br>
                                Bank: BANK ALFALAH<br>
                                IBAN: PK08ALFH0148001007326523<br>
    ...
    <script>
        ...
        function updateSummary() {
            ...
            if (promo === "PADSxPDA10" || promo === "PADS".toUpperCase()) {
